...
### Objective
Build a goods management system for e-commerce operations, covering product catalog, suppliers, warehouse transactions, inventory visibility, orders, stock counts, reporting, and barcode/QR lookup.

### Technology Requirements
- Frontend: React + TypeScript + Vite.
- Backend: Python FastAPI.
- Database: SQLite for demo, replaceable by PostgreSQL/MySQL for production.
- Packaging: Docker image `goods-management-system:v1.0` and Docker Compose.
...
2. Product management: create, edit, deactivate/delete; SKU, category, brand, unit, prices, barcode/QR, image, minimum stock, location, status.
...
### Acceptance Criteria
- Docker image `goods-management-system:v1.0` builds successfully.
...
### Mục tiêu
Xây dựng hệ thống quản lý hàng hóa cho vận hành thương mại điện tử, bao gồm danh mục sản phẩm, nhà cung cấp, giao dịch kho, tồn kho, đơn hàng, kiểm kê, báo cáo và barcode/QR.

### Yêu cầu công nghệ
- Frontend: React + TypeScript + Vite.
- Backend: Python FastAPI.
- Database: SQLite cho demo, có thể thay bằng PostgreSQL/MySQL khi production.
- Đóng gói: Docker image `goods-management-system:v1.0` và Docker Compose.
...
2. Quản lý sản phẩm: thêm, sửa, xóa/ngừng kinh doanh; quản lý SKU, danh mục, thương hiệu, đơn vị, giá, barcode/QR, hình ảnh, ngưỡng tồn, vị trí, trạng thái.
...
### Tiêu chí nghiệm thu
- Docker image `goods-management-system:v1.0` build thành công.
